package br.edu.ifc.gui.aula18.atividade;

import br.edu.ifc.gui.aula17.exemplos.Aluno;
...
public class ListaAlunosFakerGUI extends javax.swing.JFrame {

  private List<Aluno> alunos;
  private int posicaoAtual = 0;

  public ListaAlunosFakerGUI() {
    initComponents();
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ListaAlunosFakerGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new ListaAlunosFakerGUI().setVisible(true);
      }
    });
  }
